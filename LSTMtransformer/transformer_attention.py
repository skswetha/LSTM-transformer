...
class MultiHeadProjection(nn.Module):
    ...
    def _combine_heads(self, tensor):
        ...
        tensor = tensor = tensor.contiguous().view(batch_size, tensorlen, new_feature_size)   # Reshape the Tensor to remove the heads dimension and come back to a Rank-3 tensor
        return tensor
        ##########################################################################################
